...
Route::middleware(['auth', 'verified', 'approved'])->group(function () {
    ...
    Route::get('leads/export', [LeadController::class, 'exportCsv'])->middleware('throttle:exports')->name('leads.export');
    ...
    Route::get('clients/export', [ClientController::class, 'exportCsv'])->middleware('throttle:exports')->name('clients.export');
    ...
    Route::get('contracts/export', [ContractController::class, 'exportCsv'])->middleware('throttle:exports')->name('contracts.export');
    ...
    Route::post('contracts/scope-points', [ContractController::class, 'scopePoints'])->middleware('throttle:ai')->name('contracts.scope-points');
    ...
    Route::post('contracts/{contract}/clauses', [ContractController::class, 'clauses'])->middleware('throttle:ai')->name('contracts.clauses');
    Route::post('contracts/{contract}/sign', [ContractController::class, 'sign'])->name('contracts.sign');
    Route::post('contracts/{contract}/finalize', [ContractController::class, 'finalize'])->middleware('throttle:documents')->name('contracts.finalize');
    ...
    Route::get('invoices/export', [InvoiceController::class, 'exportCsv'])->middleware('throttle:exports')->name('invoices.export');
