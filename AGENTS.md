...
This application is a Laravel application. You are an expert with all listed packages. Ensure you abide by these specific versions:
...
Domain-specific skills are available in `**/skills/**`. You MUST activate the relevant skill whenever you work in that domain — don't wait until you're stuck.
